...
Journal.setupMenu = function (type) {
    ...
    var $trigger_on_mobile = $('.trigger-on-mobile'); 
    ...
    //$trigger_on_mobile.unbind('click');
    ...
    if (type === 'mobile') {
        ...
        $trigger_on_mobile.toggle(function () {
            $('> ul, > div', $(this).parent()).stop(true, true).slideDown(250);
            $($(this).siblings('span')).html('-').parent().addClass('menu-open');
        }, function () {
            $('> ul, > div', $(this).parent()).stop(true, true).slideUp(150);
            $($(this).siblings('span')).html('+').parent().removeClass('menu-open');
        });
