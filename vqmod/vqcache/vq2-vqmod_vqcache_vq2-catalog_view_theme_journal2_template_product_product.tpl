      ...
      <div class="row product-info <?php echo $this->journal2->settings->get('split_ratio'); ?>">
        ...
        <div class="left">
          ...
          <div class="image">
            ...
            <?php endforeach; ?>
            <?php endif; ?>
            <a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>"><img src="<?php echo $thumb; ?>" id="zoom_01" data-zoom-image="<?php echo $popup; ?>"  id="zoom_01" data-zoom-image="<?php echo $popup; ?>"  title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image" data-largeimg="<?php echo $popup; ?>" itemprop="image"  /></a>
          </div>
          ...
          <div class="image-gallery" style="display: none !important;">
            <?php if ($thumb) { ?>
            <a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" class="swipebox"><img src="<?php echo $thumb; ?>" id="zoom_01" data-zoom-image="<?php echo $popup; ?>"  id="zoom_01" data-zoom-image="<?php echo $popup; ?>"  title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a>
            <?php } ?>
            <?php if ($images) { ?>
            <?php foreach ($images as $image) { ?>
        ...
        <div class="right">
          ...
          <ul class="list-unstyled price" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
            ...
            <li class="product-infomation"><i>Thanh toán online hoặc thanh toán khi nhận hàng</i></li>
            <li class="product-infomation"><i>Sản phẩm sẽ có mặt tại nhà bạn trong vòng  2 – 5 ngày làm việc </i></li>
            <li class="product-infomation"><i>Bạn muốn nhận sản phẩm trong vòng 60 phút vui lòng liên hệ hotline <b>096 103 4 203</b>.</i></li>
            <li class="product-infomation"><b>SẢN PHẨM ĐƯỢC CUNG CẤP BỞI THƯƠNG HIỆU LAAS design by HA HONG LAM</b></li>
            <?php if ($points) { ?>
          ...
          <div class="social share-this <?php echo $this->journal2->settings->get('share_buttons_disable_on_mobile', 1) ? 'hide-on-mobile' : ''; ?>">
            <div class="social-loaded">
              ...
              <span class="<?php echo $item['class'] . $this->journal2->settings->get('share_buttons_style'); ?>" displayText="<?php echo $this->journal2->settings->get('share_buttons_style') ? $item['name'] : ''; ?>"></span>
              <?php endforeach; ?>
                                  <div class="fb-share-button" data-href="http://laas.vn" data-layout="button_count"></div>
            </div>
          </div>
          <?php endif; ?>
