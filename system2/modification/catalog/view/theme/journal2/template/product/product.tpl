      ...
      <div class="row product-info <?php echo $this->journal2->settings->get('split_ratio'); ?>">
        ...
        <div class="left">
          ...
          <div class="image">
            ...
            <?php endforeach; ?>
            <?php endif; ?>
            <a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>"><img src="<?php echo $thumb; ?>" id="zoom_01" data-zoom-image="<?php echo $popup; ?>"  title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image" data-largeimg="<?php echo $popup; ?>" itemprop="image"  /></a>
          </div>
          ...
          <div id="product-gallery" class="image-additional <?php echo $this->journal2->settings->get('product_page_gallery_carousel') ? 'journal-carousel' : 'image-additional-grid'; ?>">
            <?php if ($thumb) { ?>
            <a href="<?php echo isset($popup_fixed) ? $popup_fixed : $popup; ?>" title="<?php echo $heading_title; ?>"><img class='thumb' src="<?php echo isset($thumb_fixed) ? $thumb_fixed : $thumb; ?>" src-colorbox="<?php echo $popup; ?>" big_thumb='<?php echo $thumb; ?>' title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a>
            <?php } ?>
            <?php foreach ($images as $image) { ?>
            <a href="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>"><img class='thumb' src="<?php echo $image['thumb']; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" src-colorbox="<?php echo $image["popup"]; ?>" big_thumb='<?php echo $image["big_thumb"]; ?>' itemprop="image" /></a>
            <?php } ?>
          </div>
        ...
        <div class="right">
          ...
          <ul class="list-unstyled price" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
            ...
            <li class="product-infomation"><i>Nhận sản phẩm trong vòng 60 phút vui lòng liên hệ hotline <b>096 1034 203 - 0986 680 2590</b>.</i></li>
