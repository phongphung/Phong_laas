...
<!--                     <div class="comment-date">
                    ...
                    <?php endif; ?>
                    <!-- <a class="post-view-more button" href="<?php echo $post['href']; ?>"><i class="post-button-left-icon"></i><?php echo $this->journal2->settings->get('blog_button_read_more', 'Xem tiếp'); ?><i class="post-button-right-icon"></i></a> -->
                </div>
            </div>
        </div>
        <?php endforeach; ?>
