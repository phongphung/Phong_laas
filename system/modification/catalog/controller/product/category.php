...
class ControllerProductCategory extends Controller {
    ...
    if (isset($this->request->get['filter_price'])) {
      ...
      $placeholder = "/image/placeholder.png";//$this->model_tool_image->resize('placeholder.png', $this->config->get('config_image_product_width'), $this->config->get('config_image_product_height'));
			foreach ($results as $result) {
				if ($result['image']) {
					$image = "/image".$result['image'];//$this->model_tool_image->resize($result['image'], $this->config->get('config_image_product_width'), $this->config->get('config_image_product_height'));
				} else {
          echo "no image";
					$image = $placeholder;//$this->model_tool_image->resize('placeholder.png', $this->config->get('config_image_product_width'), $this->config->get('config_image_product_height'));
				}
                ...
                /*if (count($additional_images) > 0) {
                    $image2 = "/image".$additional_images[0]['image'];//$this->model_tool_image->resize($additional_images[0]['image'], $this->config->get('config_image_product_width'), $this->config->get('config_image_product_height'));
                }*/
                foreach ($additional_images as $additional_image) {
                  if ($additional_image['image'] != "") {
                    $image2 = "/image".$additional_image['image'];
                  }
                }
