...
<div class="table-responsive">
  ...
  <p>Bạn vui lòng liên hệ 0961034203 hoặc ( 08 ) 66802590 để xác nhận đơn hàng<p/>
</div>
<div class="payment"><?php echo $payment; ?></div>
<a style="display:none;" class="btn btn-danger" href="<?php echo $back; ?>"><?php echo $button_back; ?></a>
<?php } else { ?>
