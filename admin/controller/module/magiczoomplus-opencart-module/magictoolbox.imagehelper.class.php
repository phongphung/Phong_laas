        ...
        */
        function MagicToolboxImageHelperClass($path, $cache = null, $options = null, $pid = null, $url = null) {
            ...
            if(!$options) {
				...
				"imagemagick"=>array("id"=>"imagemagick","advanced"=>"1","group"=>"Miscellaneous","order"=>"550","default"=>"auto","label"=>"Path to ImageMagick binaries (convert tool)","description"=>"You can set 'auto' to automatically detect ImageMagick location or 'off' to disable ImageMagick and use php GD lib instead","type"=>"text","scope"=>"profile"),
