...
<?php if ($payment) { ?>
<table class="table table-hover table-striped payment-section">
  ...
  <tr>
	...
	<td class="image-payment"><img src="<?php echo HTTPS_SERVER . 'catalog/view/theme/default/image/payment/' . $payment_method['code'] . '.png'; ?>" alt="<?php echo $payment_method['title']; ?>" /></td>
	<?php } else { ?>
	<td></td>
	<?php } ?>
  </tr>
...
<textarea name="comment" rows="8" class="form-control checkout-note"><?php echo $comment; ?></textarea>
