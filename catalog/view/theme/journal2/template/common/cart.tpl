<div id="cart" class="btn-group btn-block">
  <p type="button" class="btn btn-inverse btn-lg heading"><a href="<?php echo $checkout; ?>"><span id="cart-total" data-loading-text="<?php echo $text_loading; ?>&nbsp;&nbsp;"><?php echo $text_items; ?></span> <i></i></a></p>
  <div class="content">
    ...
    <li class="mini-cart-info">
      <table class="table table-striped">
        ...
        <tr>
          ...
          <td class="text-center remove"><button type="button" onclick="cart.remove('<?php echo $product['key']; ?>');" title="<?php echo $button_remove; ?>"></button></td>
        </tr>
        <?php } ?>
    ...
    <li>
      <div class="mini-cart-total">
        ...
        <p class="text-right checkout"><a class="button" href="<?php echo $checkout; ?>"><?php echo $text_checkout; ?></a></p>
      </div>
    </li>
    <?php } else { ?>
    <li>
