...
$('input[name=\'option\']').autocomplete({
	...
	'select': function(item) {
		...
		$('#option > li:last-child').before('<li><input type="hidden" id="option-' + option_row + '" value="'+item['type']+'"/><a href="#tab-option' + option_row + '" data-toggle="tab"><i class="fa fa-minus-circle" onclick="$(\'a[href=\\\'#tab-option' + option_row + '\\\']\').parent().remove(); $(\'#tab-option' + option_row + '\').remove(); $(\'#option a:first\').tab(\'show\')"></i> ' + item['label'] + '</li>');
