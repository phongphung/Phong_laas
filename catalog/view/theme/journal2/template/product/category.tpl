  ...
  <div class="row"><?php echo $column_left; ?><?php echo $column_right; ?>
          ...
          <div class="product-thumb">
            <div class="image">
              <a href="<?php echo $product['href']; ?>" <?php if(isset($product['thumb2']) && $product['thumb2']): ?> class="has-second-image" style="background: url('<?php echo $product['thumb2']; ?>') no-repeat;" <?php endif; ?>>
                  <img class="lazy first-image my-thumb1" width="<?php echo $this->journal2->settings->get('config_image_width'); ?>" height="<?php echo $this->journal2->settings->get('config_image_height'); ?>" src="<?php echo $this->journal2->settings->get('product_dummy_image'); ?>" data-src="<?php echo $product['thumb']; ?>" title="<?php echo $product['name']; ?>" alt="<?php echo $product['name']; ?>" />
				  <?php if (isset($product['thumb2']) && $product['thumb2']): ?>
                    <img class="lazy first-image my-thumb2" width="<?php echo $this->journal2->settings->get('config_image_width'); ?>" height="<?php echo $this->journal2->settings->get('config_image_height'); ?>"src="<?php echo $product['thumb2']; ?>" title="<?php echo $product['name']; ?>" alt="<?php echo $product['name']; ?>" style="display:none;" />
				  <?php endif; ?>
              </a>
    ...
    <script>
      $(document).ready(function() {
         //var el = $('a');
         //if (el.hasClass('has-second-image')) {
           $('.has-second-image').live({
      	      mouseenter: function() {
      	        $(this).find('.my-thumb1').hide();
      	        $(this).find('.my-thumb2').show();
      	      }, 
      	      mouseleave: function() {
       	        $(this).find('.my-thumb1').show();
      	        $(this).find('.my-thumb2').hide();
      	      }
      	   });
         //}
      	/*$('.product-thumb.product-wrapper').each(function() {
      	  var el = $(this).find('a')
      	  if (el.hasClass('has-second-image')) {
