...
class ControllerProductManufacturer extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/manufacturer_list.tpl')) {
			  $this->response->setOutput(magiczoomplus($this->load->view($this->config->get('config_template') . '/template/product/manufacturer_list.tpl', $data),$this,'manufacturers',(isset($results) ? $results : array() )));	
		} else {
...
if (isset($this->request->get['filter_price'])) {
		...
		if (isset($this->request->get['filter_max_price'])) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/manufacturer_info.tpl')) {
				  $this->response->setOutput(magiczoomplus($this->load->view($this->config->get('config_template') . '/template/product/manufacturer_info.tpl', $data),$this,'manufacturers',(isset($results) ? $results : array() )));	
			} else {
